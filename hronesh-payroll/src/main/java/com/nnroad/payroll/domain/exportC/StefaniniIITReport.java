 ...
 * @date 2021-01-15
 */
public class StefaniniIITReport extends BaseEntity
{
    ...
    /** *收入额 */
    @Excel(name = "*收入额", cellType = Excel.ColumnType.NUMERIC, scale = 2)
    private BigDecimal income;

    /** 免税所得 */
    @Excel(name = "免税所得", cellType = Excel.ColumnType.NUMERIC, scale = 2)
    private BigDecimal fsAllowance;

    /** 基本养老保险费 */
    @Excel(name = "基本养老保险费", cellType = Excel.ColumnType.NUMERIC, scale = 2)
    private BigDecimal pension;

    /** 基本医疗保险费 */
    @Excel(name = "基本医疗保险费", cellType = Excel.ColumnType.NUMERIC, scale = 2)
    private BigDecimal medical;

    /** 失业保险费 */
    @Excel(name = "失业保险费", cellType = Excel.ColumnType.NUMERIC, scale = 2)
    private BigDecimal unemployment;

    /** 住房公积金 */
    @Excel(name = "住房公积金", cellType = Excel.ColumnType.NUMERIC, scale = 2)
    private BigDecimal housingFund;

    /** 累计子女教育 */
    @Excel(name = "累计子女教育", cellType = Excel.ColumnType.NUMERIC, scale = 2)
    private BigDecimal accumulatedChildEducation;

    /** 累计继续教育 */
    @Excel(name = "累计继续教育", cellType = Excel.ColumnType.NUMERIC, scale = 2)
    private BigDecimal accumulatedContinuingEducation;

    /** 累计住房贷款利息 */
    @Excel(name = "累计住房贷款利息", cellType = Excel.ColumnType.NUMERIC, scale = 2)
    private BigDecimal accumulatedHli;

    /** 累计住房租金 */
    @Excel(name = "累计住房租金", cellType = Excel.ColumnType.NUMERIC, scale = 2)
    private BigDecimal accumulatedHousingRent;

    /** 累计赡养老人 */
    @Excel(name = "累计赡养老人", cellType = Excel.ColumnType.NUMERIC, scale = 2)
    private BigDecimal accumulatedSfte;

    /** 累计婴幼儿照护费用 */
    @Excel(name = "累计婴幼儿照护费用", cellType = Excel.ColumnType.NUMERIC, scale = 2)
    private BigDecimal accumulatedChildCare;

    /** 企业(职业)年金 */
    @Excel(name = "企业(职业)年金", cellType = Excel.ColumnType.NUMERIC, scale = 2)
    private String annuity;

    /** 商业健康保险 */
    @Excel(name = "excel.iit_report.commercialHealthInsurance", cellType = Excel.ColumnType.NUMERIC, scale = 2)
    private BigDecimal commercialHealthInsurance;

    /** 税延养老保险 */
    @Excel(name = "商业健康保险", cellType = Excel.ColumnType.NUMERIC, scale = 2)
    private BigDecimal tdpInsurance;

    /** 其他 */
    @Excel(name = "其他", cellType = Excel.ColumnType.NUMERIC, scale = 2)
    private BigDecimal otherIit;

    /** 准予扣除的捐赠额 */
    @Excel(name = "准予扣除的捐赠额", cellType = Excel.ColumnType.NUMERIC, scale = 2)
    private BigDecimal otherTaxFreeDeductions;

    /** 减免税额 */
    @Excel(name = "减免税额", cellType = Excel.ColumnType.NUMERIC, scale = 2)
    ...
    /** 工资税合计 */
    @Excel(name = "工资税合计", cellType = Excel.ColumnType.NUMERIC, scale = 2)
    private BigDecimal sumPayrollTax;

    /** 年终奖应税合计 */
    @Excel(name = "年终奖应税合计", cellType = Excel.ColumnType.NUMERIC, scale = 2)
    private BigDecimal annualBonus;

    /** 年终奖税合计 */
    @Excel(name = "年终奖税合计", cellType = Excel.ColumnType.NUMERIC, scale = 2)
    private BigDecimal annualBonusLlt;

    /** 离职补偿金 */
    @Excel(name = "离职补偿金", cellType = Excel.ColumnType.NUMERIC, scale = 2)
    private BigDecimal indemnity;

    /** 个税合计 */
    @Excel(name = "个税合计", cellType = Excel.ColumnType.NUMERIC, scale = 2)
