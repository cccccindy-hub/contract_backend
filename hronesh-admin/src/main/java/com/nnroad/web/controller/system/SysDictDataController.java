...
import com.nnroad.system.service.ISysDictTypeService;
...
public class SysDictDataController extends BaseController
{
    ...
    @Anonymous
    @GetMapping(value = "/types/{dictTypes}")
    public AjaxResult dictTypes(@PathVariable String dictTypes)
    {
        return success( dictDataService.selectByDictTypes(Arrays.asList(dictTypes.split(","))).stream().collect(Collectors.groupingBy(SysDictData::getDictType)));
