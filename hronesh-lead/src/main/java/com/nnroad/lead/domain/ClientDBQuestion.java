...
public class ClientDBQuestion extends BaseEntity {
    ...
    public String toString() {
        return "ClientDBQuestion{" +
                "fid=" + fid +
                ", fsurvey='" + fsurvey + '\'' +
                ", freciverId='" + freciverId + '\'' +
                ", freciverName='" + freciverName + '\'' +
                ", fother='" + fother + '\'' +
                ", bdConsultant='" + bdConsultant + '\'' +
                ", fsubmitAt='" + fsubmitAt + '\'' +
                ", fsendAt='" + fsendAt + '\'' +
                ", sendAtStart='" + sendAtStart + '\'' +
                ", sendAtEnd='" + sendAtEnd + '\'' +
                ", fresult='" + fresult + '\'' +
                ", freciverEmail='" + freciverEmail + '\'' +
                ", status='" + status + '\'' +
                '}';
    }
