package com.nnroad.dict.mapper;
 ...
 *
 */
public interface DCDictDataMapper
{
    /**
     * 根据条件分页查询字典数据
     * 
     ...
     * 报表定义中所有下拉项目
     *
     * @param dictList 根据dictList查询
     * @return 结果
     */
    List<DCDictData> selectDictDataByDictList(@Param("dictList") List<String> dictList);
